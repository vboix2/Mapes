...
color_bar = ColorBar(color_mapper = color_mapper,
                     title = "Casos sospitosos de COVID19 per cada 100.000 habitants",
                     label_standoff = 8,
                     width = 500, height = 20,
...
# Figura
p = figure(title = 'Afectació del COVID a Catalunya: Casos sospitosos i confirmats (setmana ' + str(last_week) + ")",
...
p.add_tools(HoverTool(renderers = [p_municipis],
                      tooltips = [('Municipi','@NOMMUNI'),
                                  ('Casos per 100.000 hab','@PercentatgeCasos'),
                                  ('Nombre de casos','@NumCasos'),]))
